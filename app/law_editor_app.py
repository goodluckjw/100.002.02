...
with st.expander("ℹ️ 사용법 안내"):
    st.markdown(      
        ...
        "- 가운뎃점(U+318D, 법제처 사이트에서 사용)과 중간점(U+00B7, 주로 한글 프로그램과 국회 법령정보스시템에서 사용)의 구분 입력시에는 구분없이 사용될 수 있도록 하였습니다. 출력시에는 가운뎃점으로 표기됩니다. \n"
        "  - 다만, 개정문생성 시 <바꿀 단어>에 중간점을 입력한 경우에는 중간점으로 표기되어 반환됩니다. \n"
